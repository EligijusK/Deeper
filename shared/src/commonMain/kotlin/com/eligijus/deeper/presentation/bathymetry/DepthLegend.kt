...
val depthRanges = listOf(
    ...
    DepthRange("6–8 m", 6.0, 8.0, Color(0xFF1565C0)),
    DepthRange("8–10 m",8.0, 10.0, Color(0xFF0D47A1)),
    DepthRange("10–12 m",  10.0, 12.0, Color(0xFF283593)),
    DepthRange("12+ m", 12.0, null, Color(0xFF1A237E))
)
